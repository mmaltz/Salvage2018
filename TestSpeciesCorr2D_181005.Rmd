...
#View(ssuspeciesREADRICHlong)
str(ssuspeciesREADRICHlong)
ssuspeciesREADRICHlong[61,131:137]
y<-ssuspeciesREADRICHlong$HL
#str(y)
H<-ssuspeciesREADRICHlong$HL
S<-ssuspeciesREADRICHlong$Site
O<-ssuspeciesREADRICHlong$OTU_Richness_Sample
D<-ssuspeciesREADRICHlong$Description
Yr<-ssuspeciesREADRICHlong$Year
Tr<-ssuspeciesREADRICHlong$Treat
```
...
lmWLHWLTr<-lm(WLH~WLTr)
summary(lmWLHWLTr)

lmWLHWLYr<-lm(WLH~WLYr)
summary(lmWLHWLYr)

lmWLOWLTr<-lm(WLO~WLTr)
summary(lmWLOWLTr)
...
lmDWLHWLTr<-lm(DWLH~DWLTr)
summary(lmDWLHWLTr)

#lmDWLHWLYr<-lm(DWLH~DWLYr)
#summary(lmDWLHWLYr)
