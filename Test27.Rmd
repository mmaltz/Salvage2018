...
LssugenusOTURICH <- dcast(ssugenera, ID ~ ssugenus, value.var = "Genus_OTU_Richness",  fun.aggregate = sum )
LssugenusOTUREAD <- dcast(ssugenera, ID ~ ssugenus, value.var = "Genus_Read_Abundance",  fun.aggregate = sum )
